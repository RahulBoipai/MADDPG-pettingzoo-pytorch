...
import numpy as np
from pettingzoo.mpe import simple_adversary_v3, simple_spread_v3, simple_tag_v3, simple_speaker_listener_v4, simple_push_v3
...
if __name__ == '__main__':
    ...
    parser.add_argument('--env_name', type=str, default='simple_adversary_v3', help='name of the env',
                        choices=['simple_adversary_v3', 'simple_spread_v3', 'simple_tag_v3', 'simple_speaker_listener_v4', 'simple_push_v3'])
    parser.add_argument('--episode_num', type=int, default=300,
                        help='total episode num during training procedure') #30000
    parser.add_argument('--episode_length', type=int, default=10, help='steps per episode')#25
    parser.add_argument('--learn_interval', type=int, default=20,
                        help='steps interval between learning time')#100
    parser.add_argument('--random_steps', type=int, default=5e2,
